 ...
 <form id="formId" action="http://www.163.com" method="post" > 
     <table width="400px" border="0" cellspacing="0" cellpadding="0">
       <tr>
         ...
         <td> 
          <input id="loginId" name="loginName" value="tomcate" onBlur="loginBlur()"/>
       ...
       <tr>
         <td>密码：</td>
         <td> 
           <input id="pwdId" name="pwd" value="423234234" onBlur="pwdBlur()"/>
           <span id="pwdTip"></span>
         </td>
       </tr>
       <tr>
         <td>姓名：</td>
         <td> 
         <input id="userId" name="userName" value="刘志强" onBlur="userNameBlur()"/>
       ...
       <tr>
         ...
         <td>
          <select id="postId" name="post" onBlur="postBlur()">
             ...
             <option value="1" selected>咨询师</option>
       ...
       <tr>
         <td>入职时间:</td>
         <td>
           <input id="postTime" type="date"
           value="2016-01-11" name="PostTime" onBlur="timeBlur()"/>
