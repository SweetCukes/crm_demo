 ...
 <form id="formId" action="http://www.163.com" method="post" > 
     <table width="500px" border="0" cellspacing="0" cellpadding="0">
       ...
       <tr>
         ...
         <td> 
           <select name="course"  id="courseId" onBlur="courseBlur()">
             ...
             <option value="2">JavaEE就业班</option>
       ...
       <tr>
         <td>开课时间:</td>
         <td>
           <input id="startTime" type="datetime-local" name="startTime" onBlur="startBlur()"/>
          ...
          <td>结业时间:</td> 
         <td>
           <input id="endTime" type="datetime-local" name="endTime" onBlur="endBlur()"/>
           <span id="endTip"></span>
         </td>
         </tr>
          <tr>
