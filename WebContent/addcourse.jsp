 ...
 <form id="formId" action="http://www.163.com" method="post" > 
     <table width="500px" border="0" cellspacing="0" cellpadding="0">
       <tr>
         ...
         <td>
           <input id="couseId" name="couseName" onBlur="couseNameBlur()"/>
       ...
       <tr>
         <td>课程费用:</td>
         <td>
           <input id="couseMoney" type="number" name="couseMoney" onBlur="moneyBlur()"/>
          ...
          <td>总学时:</td> 
         <td>
           <input id="classHour" type="number" name="classHour" onBlur="chourBlur()"/>
